...
@app.route('/showall')
def showall():
      return render_template('result.html', result = students.query.all())


@app.route('/contact',methods=['GET', 'POST'])
def contact():
   if request.method == 'POST':
      contactdetails = tempquerys(request.form['name'],request.form['mobile'],request.form['email'],request.form['query'],datetime.now())
