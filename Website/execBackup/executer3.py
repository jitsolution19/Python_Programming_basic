...
def contact():
   if request.method == 'POST':
      contactquery = tempcontquerys(request.form['name'],request.form['mobile'],request.form['email'],request.form['query'])
...
@app.route('/showall')
def showall():
      return render_template('result1.html',contactquerys = tempcontquerys.query.all())
